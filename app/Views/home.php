...
<html lang="en">
  <head>
    ...
    <title>Tugas UTS Portofolio</title>
<!--
Reflux Template
        ...
        <div id="menu" class="menu">
          ...
          <div class="container">
            ...
            <div class="author-content">
              <h4>Muhamad Wildan Abdurahman</h4>
              <span>Front End Web Developer</span>
            </div>
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                <li><a href="#section1">Tentang Saya</a></li>
                <li><a href="#section2">Skill yang di kuasai</a></li>
                <li><a href="#section3">Hobi</a></li>
                <li><a href="#section4">Hubungi saya</a></li>
              </ul>
            </nav>
            <div class="social-network">
              <ul class="soial-icons">
                <li>
                  <a href="https://fb.com/wildan.syngates"
                    ><i class="fa fa-facebook"></i
                  ></a>
                </li>
                <li>
                  <a href="https://www.instagram.com/wildanabd_13/"><i class="fa fa-instagram"></i></a>
                </li>
                <li>
            ...
            <div class="copyright-text">
              <p>Copyright 2022 Muhamad Wildan Abdurahman</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <section class="section about-me" data-section="section1">
        <div class="container">
          <div class="section-heading">
            ...
            <span
              >Nama saya Muhamad Wildan abdurahman dengan nim 1930511086 berkuliah di Universitas Muhammadiyah Sukabumi memulai kuliah pada tahun 2019 dan mengambil program studi teknik informatika .</span
            >
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="right-text">
                  <h4>Alamat</h4>
                  <p>
                  KP.TEGAL PANJANG RT.020/006 TEGAL PANJANG KEC. CIREUNGHAS KAB. SUKABUMI
CIREUNGHAS, KAB. SUKABUMI, JAWA BARAT, 43193
                  </p>
      ...
      <section class="section my-services" data-section="section2">
        <div class="container">
          <div class="section-heading">
            ...
            <div class="line-dec"></div>
            <span
              >Saya memulai belajar programming pada awal perkuliahan dan menguasai dasar di bidang berikut :</span
            >
          </div>
          <div class="row">
            <div class="col-md-6">
      ...
      <section class="section my-work" data-section="section3">
        <div class="container">
          <div class="section-heading">
            ...
            <div class="line-dec"></div>
            <span
              >Sollicitudin ex mauris, lobortis diam euismod sit
              mencintai. Film dan pahlawan super elit, siapa busurnya, kendaraannya
              untuk memulai</span
            >
          </div>
          <div class="row">
                  ...
                  <figure class="snip1321">
                    ...
                    <figcaption>
                      <a
                        ...
                        ><i class="fa fa-search"></i
                      ></a>
                      <h4>Pemrograman Web berbasis framework</h4>
                      <span>Teman</span>
                    </figcaption>
                  </figure>
                </div>
